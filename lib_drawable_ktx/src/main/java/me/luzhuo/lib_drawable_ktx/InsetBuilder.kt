...
class InsetBuilder : DrawableBuilder {
     ...
     */
    fun setInset(insetLeft: Int, insetTop: Int, insetRight: Int, insetBottom: Int, isDp: Boolean = true): InsetBuilder {
    ...
    override fun build(): Drawable {
        return InsetDrawable(drawable, mInsetLeft.roundToInt(), mInsetTop.roundToInt(), mInsetRight.roundToInt(), mInsetBottom.roundToInt())
    }
